...
struct AudioUtilsTests {
    @Test func testConvertCMSampleBufferToPCM() async throws {
        ...
        do {
            blockBuffer = try CMBlockBuffer(length: dataSize, flags: .assureMemoryNow)
        } catch {
        ...
        var timing = CMSampleTimingInfo(
            duration: CMTime(value: 1, timescale: 44100), presentationTimeStamp: .zero, decodeTimeStamp: .invalid)
